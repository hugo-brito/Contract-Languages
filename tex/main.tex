...
In this section we will elaborate on the benefits of modelling a contract by using a DSL by taking a example to show how it is used and implemented. For this purpose, we have used the programming language Scala. %% not sure where we should introduce this or even if we should talk about why we decided for Scala.

\begin{tcolorbox}
%% NEED TO ADD SOME SORT OF LABEL TO BE ABLE TO REFER TO THIS CONTRACT
\begin{itemize}
