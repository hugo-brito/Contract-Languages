...
Unfortunately, not all contracts can be implemented using a contract language as it requires the given contract to be unambiguous in nature, such as financial contracts and in general contracts governing the exchange of resources. On top pf this, some aspects of a contract that are simply too complex to model. % comment from patrick: Is that the only reason?
